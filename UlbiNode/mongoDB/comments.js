...
ODM (Object-Document Mapping) — это технологии, используемые для работы с базами данных на уровне объектов в приложении. Однако они применяются к разным типам баз данных.
